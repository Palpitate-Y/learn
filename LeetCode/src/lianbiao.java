...
/*    发现有些人看不太懂为什么 return pre.next;
      我尝试做一下解释一下，如有问题，欢迎指正。 首先，ListNode pre = new ListNode(0);
      实例化pre,开辟了一个内存空间，pre指向这个内存空间。 ListNode cur = pre;
      实例化cur，指向与pre向同的地址， 所以在cur.next = new ListNode(sum);
